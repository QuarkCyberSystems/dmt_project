...
def get_data(filters):
	...
	data=[]
	doc=frappe.get_all("Tenant", filters=query_filters, fields=['name', 'tenant', 'apt', 'apt_no', 'status', 'contract_expiry'])
	for i in doc:
		data.append([i.get("name"),i.get("tenant"), i.get("apt"),i.get("apt_no"),i.get("status"),i.get("contract_expiry")])
		name=i.get("name")
